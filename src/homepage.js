...
export default function Homepage() {
  return (
    <div>
      ...
      <div className='Pcard'>
                <div className='pc' style={{borderRadius:'10px',margin:'10px',border:'1px solid black',height:'300',width:'230px'}}>
                        ...
                        <div className='price'>
                          <ul style={{listStyleType:'none'}} >
                            ...
                            <Button style={{marginLeft:'-20px',marginTop:'5px',width:"150px"}} variant="contained">Add to Cart</Button>
                          </ul>
                          </div>                            
                  </div>
                <div className='pc' style={{borderRadius:'10px',margin:'10px',border:'1px solid black',height:'350',width:'230px'}}>
                        <div className='cardimg' style={{height:'200px',width:'200px'}}>
